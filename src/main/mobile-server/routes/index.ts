/**
 * Routes Index - Re-export all route setup functions
 */
...
export { setupRepositoryRoutes } from './repositories'
export { setupArtifactRoutes } from './artifacts'
export { setupCoordinationRoutes } from './coordination'
