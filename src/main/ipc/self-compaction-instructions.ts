...
const ALL_BACKENDS: AIBackend[] = [
  'claude', 'claude-codex', 'gemini', 'codex', 'opencode',
  'aider', 'droid', 'hermes', 'grok',
]
...
/**
 * Compatibility export for feature branches that still call the retired
 * installer at PTY startup. The managed block is retired, so the safe legacy
 * behavior is removal rather than re-injection.
 */
export const installSelfCompactionInstructions = removeSelfCompactionInstructions
